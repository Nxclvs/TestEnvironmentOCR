...
def process_request(encoded_image):
    ...
    ocr_response = client.chat.complete(
        ...
        messages=[
            {"role": "system", "content": "Extrahiere die relevanten Informationen und gebe sie mir ohne zusätzlichen Text im JSON Format zurück."},
            {
                "role": "user",
                "content": [
...
if __name__ == "__main__":
    path = r"C:\Users\Niclas Wienzek\Desktop\Dev\TestEnvironmentOCR\testfiles\output_page_4.pdf"
    ...
    print(json.dumps(data, indent=4, ensure_ascii=False))  # Saubere Ausgabe im Terminal
